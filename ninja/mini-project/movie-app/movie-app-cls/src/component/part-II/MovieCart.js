...
class MovieCart extends React.Component{
    render(){
        const{title,plot,poster,rating,price,counter,incCounter,decCounter,delBtn,fav,isIncart,addCounter,remCounter,delCounter}=this.props;
    return(
        <>
           <div className="main">
                ...
                <div className="right">
                    ...
                    <div className="review">
                        ...
                        <img className="str-btn" alt="increase" src={incCounter} onClick={addCounter}/>
                            <img className="str-btn" alt="Decrease" src={decCounter} onClick={remCounter}/>
                            <img  className="str-btn del_btn" alt="delete"src={delBtn} onClick={delCounter}/>
                        </div>
